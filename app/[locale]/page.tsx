...
/**
 * The redesigned landing page for Americans in Alsace.
 * Focused on community content now that Auth is moved to dedicated pages.
 */
            ...
            <section aria-labelledby="events-heading">
              ...
              <div className="bg-white p-8 rounded-xl border border-[var(--color-border)] shadow-sm">
                <p className="text-[var(--color-text-muted)] italic text-center py-8">
                  Stay tuned for our Summer BBQ and July 4th celebrations! Details will be posted here and sent via email.
                </p>
              </div>
            </section>
          </div>
