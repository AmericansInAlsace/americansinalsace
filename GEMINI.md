...
- **Mandatory Plan Recommendations & Criteria:** All execution plans created must explicitly start with a section defining the recommended sub-agent and the mandatory skills to be leveraged, and must conclude with a dedicated 'Acceptance Criteria' section.
